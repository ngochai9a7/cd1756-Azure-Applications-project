...
class Config(object):
    ...
    SQL_SERVER = os.environ.get('SQL_SERVER') or 'article-cms-servers.database.windows.net'
    ...
    CLIENT_SECRET = "WPn8Q~bExjie25iYIMUlY.LaP5NM3FL~fTeLpbc2"
    ...
    CLIENT_ID = "ca88d640-69de-44da-ba4f-ed3c38fbb36a"
